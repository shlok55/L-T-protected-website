<%@ Page Language="C#" AutoEventWireup="true" CodeFile="faq.aspx.cs" Inherits="Sop_Project.WebForm6" %>
...
<body>
    ...
    >
      <div class="container">
        <a class="navbar-brand logo" href="#">Larsen & Turbo</a
        ><button
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="LOGIN_NEW.aspx">Login</a>
            </li>
          </ul>
        </div>
      </div>
